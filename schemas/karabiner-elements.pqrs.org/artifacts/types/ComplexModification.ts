...
/**
 * Title for the complex modification.
 */
export type Title = string;
/**
 * A list of manipulators that define the complex modification.
 *
 * @minItems 1
 */
export type Manipulators = [Manipulator, ...Manipulator[]];
/**
 ...
 */
export type FromKeyCodes = (FromAndToKeyCodes | FromOnlyKeyCodes) &
  string &
  (FromAndToKeyCodes | FromOnlyKeyCodes) &
  string;
/**
 ...
 * Modifier key codes.
 */
export type ModifierKeyCodes = (CapsLockKeyCode | HyperKeyCodes | StickyModifierKeyCodes | AnyKeyCode) &
  string &
  (CapsLockKeyCode | HyperKeyCodes | StickyModifierKeyCodes | AnyKeyCode) &
  string &
  (CapsLockKeyCode | HyperKeyCodes | StickyModifierKeyCodes | AnyKeyCode) &
  string &
  (CapsLockKeyCode | HyperKeyCodes | StickyModifierKeyCodes | AnyKeyCode) &
...
/**
 * Karabiner-Elements complex modification file (assets/complex_modifications).
 */
export interface ComplexModification {
  $schema?: Schema;
  title: Title;
